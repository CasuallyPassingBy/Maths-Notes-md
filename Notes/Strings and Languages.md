...
We see that if $\Sigma$ is an alphabet, then $(\Sigma^*, \varepsilon, \cdot )$ is a monoid. To be more exact we see that $(\Sigma^*, \varepsilon, \cdot )$ is s [[Free Object in Categories|free object]] in the category of monoids generated by $\Sigma$. 
