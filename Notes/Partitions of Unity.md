...
**Def:** A partition of unity $\{f_\alpha \mid \alpha < \kappa\}$ on a space $X$ is *subordinated to a cover $\cal A$* of $X$ if the cover $\{f^{-1}_\alpha(0,1] \mid \alpha < \kappa\}$ of $X$ is a refinement of $\cal A$. Conversely, a cover $\cal U$ of a space $X$ is said to be *numerable* if it has a subordinated partition of unity. ^e9b5fd
