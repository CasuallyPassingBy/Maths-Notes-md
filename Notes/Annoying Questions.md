...
- [ ] What happens when $\mathcal K\langle X \rangle$ is paracompact?
	- Immediately, we know that $\mathcal F\langle X\rangle$ is paracompact and thus for every $n<\omega$, $X^n$ is paracompact. 
	- [ ] Is $X^\omega$ also paracompact?
	- [ ] Can we exploit and get a nice equivalence?
...
- [ ] What happens if the $\mathcal F\langle X\rangle$ is a Lašnev space? how does it interact with $X$?
	-  Resources: 
		...
		- [Metrizability, generalized metric spaces and g-functions](https://dml.cz/bitstream/handle/10338.dmlcz/106689/CommentatMathUnivCarol_029-1988-4_12.pdf)
