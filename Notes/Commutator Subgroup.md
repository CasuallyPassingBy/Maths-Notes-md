...
**Th:** Let $G$ be a group. $Z^m(G) = G$ iff $L_{m+1}(G)$. It follows that $G$ is [[Nilpotent Groups|nilpotent]] of class $m$ iff $L_{m+1}(G) = 1$, and $m$ is the least integer that satisfies this. 