...
**Def:** The *vague topology* is the weak*-topology on $M(X, \Bbb F)$. In particular, a net of measures $(\mu_{\sigma})_{\sigma\in\Sigma}$ converges vaguely to measure $\mu$ whenever for all test functions $f\in \mathcal C_0(X, \Bbb F)$,  $$\int f\, d\mu_\sigma \to \int f\, d\mu. $$
