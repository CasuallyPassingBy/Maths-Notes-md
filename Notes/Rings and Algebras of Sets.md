...
**Def:** The *Borel $\sigma$-algebra* on $\Bbb R^d$ is the $\sigma$-algebra on $\Bbb R^d$ generated by the collection of open subsets of $\Bbb R^d$ are those that belong to ${\cal B}(\Bbb R^d)$. The *Borel subsets* of $\Bbb R^d$ are those that belong to ${\cal B} (\Bbb R^d)$. In the case $d = 1$, we write ${\cal B}(\Bbb R)$. 

**Prop:** The $\sigma$-algebra ${\cal B}(\Bbb R)$ of Borel subsets of $\Bbb R$ is generated by each of the following collections of sets:
- the collection of all closed subsets of $\Bbb R$;
- the collection of all subintervals of $\Bbb R$ of the form $(-\infty, b]$;
- the collection of all subintervals of $\Bbb R$ of the form $(a, b]$. 

**Prop:** The $\sigma$-algebra ${\cal B}(\Bbb R^d)$ of Borel subsets of $\Bbb R^d$ is generated by each of the following collections of sets:
- the collection of all closed subsets of $\Bbb R^d$;
- the collection of all half-spaces in $\Bbb R^d$ that have the form $\{(x_1, \dots, x_d) \mid x_i \le b\}$ for some index $i$ and some $b\in \Bbb R$;
- the collection of all all rectangles in $\Bbb R^d$ that have the dorm $\{(x_1,\dots, x_d) \mid a_i < x_i \le b_i \text{ for }i = 1,\dots, d\}$.

**Prop:** We see that each closed subset of $\Bbb R^d$ is $G_\delta$ and each open subset of $\Bbb R^d$ is an $F_\sigma$. 

**Prop:** Let $X$ be a set, and let $\scr A$ be an algebra on $X$. Then $\scr A$ is a $\sigma$-algebra if either
