...
**Prop:** the Lie algebra of $\text{Sp}(2n,\Bbb R)$ is isomorphic to $$\mathfrak{sp}(2n) =\{X \in \mathcal M_{2n}(\Bbb R) \mid X^\top J +JX = 0\} $$Meaning that $\text{Lie}(\text{Sp}(2n, \Bbb R)) \cong\mathfrak{sp}(2n)$. 
