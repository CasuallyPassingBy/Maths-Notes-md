...
Links: [[Module and Algebra (Structure)]], [[Ring]], [[Ring homomorphisms]]
...
**Obs:** We note that $S_0 S_0 \subseteq S_0$ this implies that $S_0$ is a subring of the graded ring $S$ and then $S$ is an $S_0$-module. If $S_0$ is in the centre of $S$ and ti contains an identity of $X$, then $S$ is an $S_0$*-algebra*. 
