...
**Prop:** 
- If $n \ge 3$, then $Z(S_n) = 1$. 
- If $n \ge 4$, then $Z(A_n) = 1$.
### Conjugacy Classes
...
**Cauchy Formula Again:** The number of distinct permutations of type $(c_1, \dots, c_n)$ is $$n! \prod_{k = 1}^n (k^{c_k} c_k!)^{-1}$$
