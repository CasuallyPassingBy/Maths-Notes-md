...
**Prop:** Let $\sf Diff_1$ be the category of smooth manifolds and diffeomorphisms and $\sf VB$ the category of smooth vector bundles and smooth bundle homomorphism, and let $T, T^*:\sf Diff_1\to VB$ be the tangent and cotangent functors, respectively. There does not exists a natural transformation from $T$ to $T^*$. 