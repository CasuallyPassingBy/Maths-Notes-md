...
A topological space $X$ is a *perfect* space if every open set is an $F_\sigma$ set. Equivalently, a space is perfect if every closed set is $G_\delta$.

Being perfect is a topological property.

Being perfect is a hereditary property.
