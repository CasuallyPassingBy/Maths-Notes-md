...
**Orbit Criterion for Covering Automorphisms:** Let $q:E\to X$ be a covering map. If $e_1, e_2\in E$ are two points in the same fiber $q^{-1}\{x\}$, there exists a covering automorphism taking $e_1$ to $e_2$ iff the induced subgroups $q_*[\pi_1(E, e_1)]$ and $q_*[\pi_1(E, e_2)]$ of $\pi_1(X, x)$ are equal. 
